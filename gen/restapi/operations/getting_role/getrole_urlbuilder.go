...
// GetroleURL generates an URL for the getrole operation
...
func (o *GetroleURL) Build() (*url.URL, error) {
	...
	var _path = "/role/{designation}/{apiName}"

	aPIName := o.APIName
	if aPIName != "" {
		_path = strings.Replace(_path, "{apiName}", aPIName, -1)
	} else {
		return nil, errors.New("apiName is required on GetroleURL")
	}

	designation := o.Designation
	if designation != "" {
		_path = strings.Replace(_path, "{designation}", designation, -1)
	} else {
		return nil, errors.New("designation is required on GetroleURL")
	}
